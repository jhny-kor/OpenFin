...
export type ToolContext = {
  ...
  supportExcludedSummary: (items: readonly FinanceItem[], query: string, region: string | undefined, filters: SearchFilters, allowedTypes: ReadonlySet<string> | null, resultIds: ReadonlySet<string>, limit: number, scoreCache?: ReadonlyMap<string, number>) => Record<string, number>;
