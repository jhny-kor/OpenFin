...
export type ToolContext = {
  ...
  matchesSearchFilters: (item: FinanceItem, filters: SearchFilters, artifacts: FinanceArtifactSet, freshnessCache?: Map<string, string | null>) => boolean;
  ...
  fetchItemGraph: (env: Env, id: string, include?: readonly string[]) => Promise<{ item: FinanceItem; itemsById: Map<string, FinanceItem> }>;
