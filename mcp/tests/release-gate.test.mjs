...
const readyManifest = {
  ...
  openfin_120_live_regression: { status: "current", mode: "live", checked_at: new Date().toISOString(), manifest_checksum: "manifest", loaded_index_checksum: "index", deployment_commit: "commit", test_count: 120, passed_count: 120, failed_count: 0, skipped_count: 0 },
