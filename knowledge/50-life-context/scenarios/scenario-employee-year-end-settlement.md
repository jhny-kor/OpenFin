---
{
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "scenario.employee.year-end-settlement 근로자 연말정산 경로 scenario 근로소득이 있는 근로자가 연말정산에서 소득공제, 세액공제, 신고기한을 순서대로 확인하는 경로입니다. scena",
    "provenance_shard": "reference",
    "source_ids": [
      "source.nts.year-end-settlement.calculation",
      "source.nts.employee-income-statement"
  ...
  "record_checksum": "sha256:6bff6bc47043597b63196ae533dfda5a8701ca35fa93fd1287b497a1b0a5569e"
}
---
