---
{
  "id": "source.fss.finlife.api",
  "title": "금융감독원 금융상품통합비교공시 금융상품한눈에 API",
  "type": "source",
  "description": "금융회사, 정기예금, 적금, 연금저축, 주택담보대출, 전세자금대출, 개인신용대출 상품의 공식 비교공시 API 원천입니다.",
  "basis_year": null,
  "parents": [],
  "children": [],
  "related": [],
  ...
  "urls": {
    "canonical": "https://finlife.fss.or.kr/finlifeapi/",
    "api": "https://finlife.fss.or.kr/finlifeapi/",
    "documentation": null
  },
  "access": {
    "method": "api",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "source.fss.finlife.api 금융감독원 금융상품통합비교공시 금융상품한눈에 api source 금융회사, 정기예금, 적금, 연금저축, 주택담보대출, 전세자금대출, 개인신용대출 상품의 공식 비교공시 api ",
    "provenance_shard": "reference",
    "source_ids": []
  },
