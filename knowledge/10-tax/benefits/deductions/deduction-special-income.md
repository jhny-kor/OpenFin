---
{
  ...
  "structured_summary": {
    "tax": {
      ...
      "limits": {
        ...
        "criterion_4": 6000000,
        "criterion_5": 8000000,
        "criterion_6": 18000000,
        "criterion_7": 20000000
      },
      "thresholds": {},
      "eligible_persons": [
        "근로제공기간 중 부담분",
  ...
  "search_projection": {
    ...
    "search_text": "deduction.special-income 특별소득공제 deduction 근로소득 연말정산 계산 구조에서 차감소득금액을 산출할 때 반영되는 특별소득공제 묶음입니다. 소득세법 제52조 source.nts.year-e",
    "provenance_shard": "reference",
    "source_ids": [
      "source.nts.year-end-settlement.calculation",
      "source.nts.year-end-settlement.deduction-limit",
  ...
  "record_checksum": "sha256:d1e8701a16aadda6a2f0adfe2350b8a76c349b2cbd81d138904bf3b818e98f47"
}
---
