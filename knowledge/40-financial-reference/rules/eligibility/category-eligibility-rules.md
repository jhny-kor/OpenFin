---
{
  ...
  "title": "요건 질문 규칙",
  "type": "category",
  "canonical_folder": "40-financial-reference/rules/eligibility",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "category.eligibility-rules 요건 질문 규칙 category 생활어를 공식 항목 후보로 연결한 뒤 실제 적용 여부를 판단하기 위해 사용자에게 묻는 요건 규칙입니다. eligibility-rule ",
    "provenance_shard": "reference",
    "source_ids": [
      "source.nts.year-end-settlement.calculation"
    ]
  ...
  "record_checksum": "sha256:8cf7a18ad77ce6b44a3611aca8391388333de63440e3581d0daa1baa9755f291"
}
---
