---
{
  ...
  "title": "중복·충돌 규칙",
  "type": "category",
  "canonical_folder": "40-financial-reference/rules/conflicts",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "category.conflict-rules 중복·충돌 규칙 category 같은 지출이나 가구 기준이 여러 공제와 충돌하거나 중복 제한을 받는지 확인하는 규칙입니다. conflict-rule source.nts.ye",
    "provenance_shard": "reference",
    "source_ids": [
      "source.nts.year-end-settlement.calculation"
    ]
  ...
  "record_checksum": "sha256:4e1f85a51cf3a9b80c8ef9a3ff475f216aa87efad71aa23e5c490fc9036f48a0"
}
---
