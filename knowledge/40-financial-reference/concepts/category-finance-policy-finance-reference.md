---
{
  ...
  "source_registry_id": "source.fsc.inclusive-finance-products",
  "source_registry_status": "registered",
  "provenance": [
    {
      "source_id": "source.fsc.inclusive-finance-products",
      "original_url": "https://www.data.go.kr/data/15094787/openapi.do",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "category.finance.policy-finance-reference 정책금융 기준정보 category 서민금융상품, 정책 주택대출, 취급기관, 상담센터, 지원실적을 기존 대출상품과 연결하기 위한 기준 축입니다",
    "provenance_shard": "reference",
    "source_ids": [
      "source.fsc.inclusive-finance-products",
      "source.fsc.inclusive-finance-performance",
