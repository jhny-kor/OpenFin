---
{
  ...
  "source_registry_id": "source.fsc.fund-products-basic",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "category.finance.investment-products 투자상품 후보 category 펀드, 퇴직연금, 변액보험 펀드처럼 예금·대출·보험과 함께 비교될 수 있는 투자성 금융상품 후보입니다. finance-",
    "provenance_shard": "reference",
    "source_ids": [
      "source.fsc.fund-products-basic",
      "source.fsc.retirement-pension-basic",
