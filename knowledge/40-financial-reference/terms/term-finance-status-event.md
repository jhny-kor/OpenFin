---
{
  "id": "term.finance.status-event",
  "title": "상품 상태 변경 이벤트",
  "type": "term",
  "description": "신규, 조건변경, 판매중단, 만료, 폐지처럼 금융상품의 현재 추천 가능성을 바꾸는 상태 전이입니다.",
  "basis_year": 2026,
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "term.finance.status-event 상품 상태 변경 이벤트 term 신규, 조건변경, 판매중단, 만료, 폐지처럼 금융상품의 현재 추천 가능성을 바꾸는 상태 전이입니다. finance-reference-on",
    "provenance_shard": "reference",
    "source_ids": [
      "source.fsc.financial-company-basic",
      "source.fsc.financial-company-credit",
  ...
  "record_checksum": "sha256:4dc3de5bb9148d04c3b5f6cea7227e81bbfd4e81e589fd966a8cfe39cba57838"
}
---
