---
{
  ...
  "source_registry_id": "source.govkr.basic-livelihood-benefit",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "term.median-income 기준 중위소득 term 복지급여와 정책금융 지원대상 판정에 쓰이는 가구원 수별 중위소득 기준입니다. term source.govkr.basic-livelihood-benefit so",
    "provenance_shard": "reference",
    "source_ids": [
      "source.govkr.basic-livelihood-benefit",
      "source.fsc.youth-future-savings"
