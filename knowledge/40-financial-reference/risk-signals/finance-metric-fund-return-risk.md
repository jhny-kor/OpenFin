---
{
  "id": "finance.metric.fund-return-risk",
  "title": "펀드 수익률·위험등급",
  "type": "risk-signal",
  "description": "공모펀드와 ETF를 수익률, 위험도, 투자지역, 설정액, 총보수, 투자설명서 기준으로 비교하기 위한 투자상품 지표입니다.",
  "basis_year": 2026,
  ...
  "source_registry_id": "source.kofia.fund-oneclick",
  ...
  "provenance": [
    ...
    },
    {
      ...
      "original_url": "https://www.fsc.go.kr/no010101/72549",
      "source_record_id": null,
      "locator": null,
      "supported_fields": [
        "title",
    ...
    },
    {
      ...
      "original_url": "https://www.data.go.kr/data/15094792/openapi.do",
      "source_record_id": null,
      "locator": null,
      "supported_fields": [
        "title",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "finance.metric.fund-return-risk 펀드 수익률·위험등급 risk-signal 공모펀드와 etf를 수익률, 위험도, 투자지역, 설정액, 총보수, 투자설명서 기준으로 비교하기 위한 투자상품 지표입",
    "provenance_shard": "reference",
    "source_ids": [
      "source.kofia.fund-oneclick",
      "source.fsc.funddamoa-guide",
  ...
  "record_checksum": "sha256:6e5d8fcd1c98c76a3a632d1ae235c27bf25859c9236557fb9afd0076315ef868"
}
---
