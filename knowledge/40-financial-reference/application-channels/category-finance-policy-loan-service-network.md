---
{
  "id": "category.finance.policy-loan-service-network",
  "title": "정책대출 취급기관·상담센터",
  "type": "category",
  "canonical_folder": "40-financial-reference/application-channels",
  "population_status": "planned",
  "population_reason": "공식 출처에서 해당 상품군 레코드를 아직 수집하지 않았습니다. 분류는 유지하되 인스턴스는 비어 있습니다.",
  "description": "정책대출 상품 자체가 아니라 취급기관, 주소, 상담센터, 미소금융 지점 정보를 보강하는 후보입니다. 활용신청 완료 후에도 현재 키는 관련 공공데이터 API에서 403이므로 권한 전파가 확인될 때까지 상품 상세에 섞지 않습니다.",
  "basis_year": 2026,
  ...
  "source_registry_id": "source.data.go.kr.kinfa-loan-handling-agencies",
  "source_registry_status": "registered",
  "provenance": [
    {
      "source_id": "source.data.go.kr.kinfa-loan-handling-agencies",
      "original_url": "https://www.data.go.kr/data/15074508/openapi.do",
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "category.finance.policy-loan-service-network 정책대출 취급기관·상담센터 category 정책대출 상품 자체가 아니라 취급기관, 주소, 상담센터, 미소금융 지점 정보를 보강하는 후보",
    "provenance_shard": "reference",
    "source_ids": [
      "source.data.go.kr.kinfa-loan-handling-agencies",
      "source.data.go.kr.kinfa-support-centers"
  ...
  "record_checksum": "sha256:e7712e26b40abdbfa1b46a98e3734e027111e326f5908cdba8d9d809f5d8aa11"
}
---
