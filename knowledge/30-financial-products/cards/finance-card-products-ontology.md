---
{
  "id": "finance.card-products-ontology",
  "title": "카드상품 온톨로지",
  "type": "domain",
  "canonical_folder": "30-financial-products/cards",
  "population_status": "populated",
  "description": "신용카드·체크카드·카드대출·결제성 리볼빙의 전월실적, 혜택조건, 연회비, 금리·수수료율, 판매상태를 구조화하는 금융상품 온톨로지입니다. 카드다모아 대표상품과 발급사 공식 전체 목록을 함께 보존합니다.",
  "basis_year": 2026,
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "finance.card-products-ontology 카드상품 온톨로지 domain 신용카드·체크카드·카드대출·결제성 리볼빙의 전월실적, 혜택조건, 연회비, 금리·수수료율, 판매상태를 구조화하는 금융상품 온톨로지입",
    "provenance_shard": "reference",
    "source_ids": [
      "source.crefia.card-products",
      "source.crefia.carddamoa",
  ...
  "record_checksum": "sha256:a16f0f43801e7cf892d6c641a596da17385ecaba70fced7b8275dd0c54990b98"
}
---
