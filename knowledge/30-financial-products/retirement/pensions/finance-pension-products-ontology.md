---
{
  "id": "finance.pension-products-ontology",
  "title": "연금저축 상품 온톨로지",
  "type": "domain",
  "canonical_folder": "30-financial-products/retirement/pensions",
  "population_status": "populated",
  "description": "세제적격 연금저축(연금저축보험·연금저축펀드·연금저축신탁)의 공시이율·최저보증이율·과거수익률, 납입·연금개시 조건, 판매상태와 연말정산 세액공제 연계를 구조화하는 금융상품 온톨로지입니다.",
  "basis_year": 2026,
  ...
  "search_projection": {
    ...
    "search_facets": {},
    "search_text": "finance.pension-products-ontology 연금저축 상품 온톨로지 domain 세제적격 연금저축(연금저축보험·연금저축펀드·연금저축신탁)의 공시이율·최저보증이율·과거수익률, 납입·연금개시 조건, 판매",
    "provenance_shard": "reference",
    "source_ids": [
      "source.fss.finlife.api",
      "source.fss.integrated-pension-portal",
  ...
  "record_checksum": "sha256:4ec060bd5d082a6e11fa70951941ff658a8c6bf48adfe139f6cda77078126774"
}
---
